...
setwd("~/PleuroceridaePopGen/Lithasia_hubrichti/L_hubrichti_m5M3n3_R80_maf025_multi/") ## The directory where the files are located
chunkfile<-"L_hubrichti_m5M3n3_R80_maf025_multi.haps_chunks.out" ## RADpainter output file
mcmcfile<-"L_hubrichti_m5M3n3_R80_maf025_multi.haps_chunks.mcmc.xml" ## finestructure mcmc file
treefile<-"L_hubrichti_m5M3n3_R80_maf025_multi.haps_chunks.mcmcTree.xml" ## finestructure tree file
### 2) EDIT THIS PATH TO WHERE YOU WANT THE PLOTS:
plotsFolder <- "~/PleuroceridaePopGen/Lithasia_hubrichti/L_hubrichti_m5M3n3_R80_maf025_multi/"
### 3) SET VALUES FOR THESE VARIABLES: "analysisName" will be included in output plots
analysisName <- "L_hubrichti_m5M3n3_R80_maf025_multi";  maxIndv <- 10000; maxPop<-10000


### 4) EDIT THE PATH TO YOUR COPY of FinestructureLibrary.R
source("~/mussels/M_marrianae/scripts/FinestructureLibrary.R", chdir = TRUE) # read in the R functions, which also calls the needed packages
